...
After the ETL process the file is moved to a backup folder to keep track of all the files upload to the database. This files are renamed with the date of ingest.
